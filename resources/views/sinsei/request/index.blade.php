        ...
        <section class="left_page left">
            ...
            <table>
                <tr class="visit_place">
                    ...
                    <td class="s_40">
                        ...
                        <p class="place left right_30">出勤</p><p class="place left">09:00</p>
                    </td>
                    <td class="s_40">
                        <div class="selectbox bottom_10">
                            <select class="mm_size">
                ...
                <tr>
                    <td>
                        ...
                        <input class="ss_size left" name="" type="text" value="09:00">
                    </td>
                    <td>
                        <div class="right_10 left">
                        ...
                        <input class="ss_size left" name="" type="text" value="18:00">
                    </td>
                </tr>
            </table>
            <table class="top_20">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <div class="search_setting">
                            <div class="selectbox left">
                                <select class="s_size left">
                                    <option selected value=""></option>
                                    <option value="有給">有給</option>
                                    <option value="有休">有休</option>
                                    <option value="前給">前給</option>
                                    <option value="前休">前休</option>
                                    <option value="後給">後給</option>
                                    <option value="後休">後休</option>
                                    <option value="半給">半給</option>
                                    <option value="半休">半休</option>
                                    <option value="時有">時有</option>
            ...
            <table class="top_20">
                ...
                <tr>
                    ...
                    <td class="bg_light_gray_line">
                        <input class="ss_size right_10" name="" type="text"><span class=" right_10">〜</span><input class="ss_size" name="" type="text">
                    </td>
                    <td></td>
                </tr>
                <tr>
            ...
            <table class="top_20">
                <tr>
                    ...
                    <td class="bg_light_gray_line s_40"><input class="ss_size" name="" type="text"></td>
                    <td></td>
                </tr>
                <tr>
                    <td class="bg_gray">(内)深休</td>
                    <td class="bg_light_gray_line"><input class="ss_size" name="" type="text"></td>
                    <td></td>
                </tr>
                <tr>
                    <td class="bg_gray">遅早</td>
                    <td class="bg_light_gray_line"><span class="right_10">遅刻</span><input class="ss_size right_10" name="" type="text"><span class="right_10 left_10">早退</span><input class="ss_size" name="" type="text"></td>
                    <td></td>
                </tr>
            </table>
            <table class="top_20">
