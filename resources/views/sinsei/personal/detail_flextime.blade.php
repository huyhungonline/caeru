    ...
    <section class="person_result_table">
        <table class="left s_60">
            <tr>
                ...
                <!-- 申請中 -->
                <!--					<th class="s_10 bg_apply" rowspan="2"><p>時間外</p><p class="modal-open overtime red" data-target="con2">(4:00)</p></th>-->
                <!-- 承認 -->
                <!--                    <th class="s_10 bg_approval" rowspan="2"><p>時間外</p><p class="modal-open overtime" data-target="con3">(4:00)</p></th>-->
                <!-- 否決 -->
                <!--                    <th class="s_10 bg_reject" rowspan="2"><p>時間外</p><p class="modal-open overtime" data-target="con4">(0:00)</p></th>-->
            </tr>
            <tr>
