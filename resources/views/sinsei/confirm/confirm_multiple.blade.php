        ...
        <section class="left_page left">
            ...
            <table class="top_20">
                ...
                <tr>
                    ...
                    <td class="bg_light_gray_line"><span class="right_10">遅刻</span><span class="right_10"></span><span class="right_10 left_10">早退</span><span class="right_10"></span></td>
                    <td><span class="right_10">遅刻</span><span class="right_10"></span><span class="right_10 left_10">早退</span><span class="right_10"></span></td>
                </tr>
            </table>
            <section class="top_20">
                ...
                <div class="description">
                    <p class="left harf_box">2016年03月03日(月)10:32申請</p>
        ...
        <section class="left_page left">
            ...
            <table>
                <tr class="visit_place">
                    ...
                    <td class="s_40">
                        <p class="l_font"></p>
                        <p class="place left right_30">出勤</p>
                    </td>
                    <td class="s_40">
                        <p class="l_font"></p>
                        <p class="place left right_30">退勤</p>
                    </td>
                </tr>
                <tr class="visit_place">
                    <td></td>
            ...
            <table class="top_20">
                ...
                <tr>
                    <td class="bg_gray">休日形態</td>
                    <td colspan="2" class="bg_apply">有給</td>
                </tr>
            </table>
            <table class="top_20">
                <tr>
            ...
            <section class="top_20">
                ...
                <table class="description_table">
                    <tr>
                        <td class="s_50 contact">有給をお願いします</td>
                        <td class="s_50"><textarea name="remarks"></textarea></td>
                    </tr>
                </table>
                <div class="description">
