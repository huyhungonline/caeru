...
@push('scripts')
    ...
    <script defer src="{{ asset('/js/components/totalization_searcher.js') }}"></script>
...
@section('content')
    <main id="attendance_detail">
        <section class="title">
            <p class="breadcrumb"><span>勤怠管理</span><span>&emsp;&#62;&emsp;勤怠集計</span></p>
            <div class="title_wrapper">
                ...
                <div class="worklocation">
                    ...
                    @include('layouts.work_location_picker', ['list' => $picker_list, 'target' => 'totalization_list', 'singular' => false])
                </div>
            </div>
        </section>
        @include('totalization.search_box',['show_toggle_button' => true])
        @include('totalization.search_result')
    </main>
@endsection